...
.reload svg {
  ...
  <text text-anchor="start" x="10" y="65" class="text text-stroke" style="font-size: 4px;" clip-path="url(#text3)">We are a food delivery service company. We provide food to your home in a shortest</text>
 ...
 the best food to our customer.
  </text>
  
  
  <text text-anchor="start" x="10" y="30" class="text text-stroke text-stroke-2" clip-path="url(#text1)">FOOD DELIVERY SERVICE</text>
  <text text-anchor="start" x="10" y="45" class="text text-stroke text-stroke-2" style="font-size: 7.5px;" clip-path="url(#text2)">WELCOME TO OUR FOOD NETWORK</text>
  <text text-anchor="start" x="10" y="65" class="text text-stroke text-stroke-2" style="font-size: 4px;stroke: #000;" clip-path="url(#text3)">We are a food delivery service company. We provide food to your home in a shortest</text>
 <text text-anchor="start" x="10" y="70" class="text text-stroke text-stroke-2" style="font-size: 4px;stroke: #000;" clip-path="url(#text4)"> possible time and cheaper rate. Our goal is to deliver
 the best food to our customer.</text>

 
  <defs>
    <clipPath id="text1">
      <text text-anchor="start" x="10" y="30" class="text">FOOD DELIVERY SERVICE</text>
    </clipPath>
    <clipPath id="text2">
      <text text-anchor="start" x="10" y="45" class="text" style="font-size: 7.5px;">WELCOME TO OUR FOOD NETWORK</text>
    </clipPath>
    <clipPath id="text3">
             <text text-anchor="start" x="10" y="65" class="text" style="font-size: 4px;">We are a food delivery service company. We provide food to your home in a shortest</text>
    </clipPath>
    <clipPath id="text4">
